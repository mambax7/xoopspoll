...
//        }
    ...
    public static function deleteByPollId(int $pid): mixed
    {
        ...
        $GLOBALS['xoopsLogger']->addDeprecated(__METHOD__ . ' is deprecated since Xoopspoll 1.40, please use Log and LogHandler methods instead.' . " Called from {$trace[0]['file']}line {$trace[0]['line']}");
    ...
    public static function deleteByOptionId(int $opt_id): mixed
    {
        ...
        /** @var LogHandler $slogHandler */
        $slogHandler = self::getStaticLogHandler();
        $criteria    = new \Criteria('option_id', $opt_id, '=');
